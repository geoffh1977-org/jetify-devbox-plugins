# ZSH Starship Terminal Environment

A pre-packaged set of tools which create a decorative and functional enivronment based on ZSH. The plug contains the following:

- ZSH - The Z Shell interperator is the base of the plugin.
